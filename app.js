...
function systemKey(system){const value=(system||"").toLowerCase().replace(/\s+/g,"");if(value==="nidin"||value.includes("nidin"))return"nidin";if(value==="ubereats"||value.includes("ubereats"))return"uber-eats";if(value==="foodpanda"||value.includes("foodpanda"))return"foodpanda";return"other";}
